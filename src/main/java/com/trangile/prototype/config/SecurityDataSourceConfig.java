...
@EnableJpaRepositories(
		basePackages = "com.trangile.prototype.security.repository",
...
public class SecurityDataSourceConfig {
    ...
    public LocalContainerEntityManagerFactoryBean securityEntityManagerFactory()
    {
        ...
        factory.setPackagesToScan(new String[]{"com.trangile.prototype.security.entity"});
...
//		databasePopulator.addScript(new ClassPathResource("security-data.sql"));
		...
		dataSourceInitializer.setEnabled(env.getProperty("security.datasource.initialize", Boolean.class, false));
