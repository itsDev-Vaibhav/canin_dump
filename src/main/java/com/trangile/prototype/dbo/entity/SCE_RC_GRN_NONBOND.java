...
public class SCE_RC_GRN_NONBOND {
	...
	public SCE_RC_GRN_NONBOND(Long id, String mESSAGE_ID, String wHSEID, String documentNo, String description,
			...
			String qualityStatus, String tNOPAL, String sourceSubType) {
		Id = id;
	...
	public String toString() {
		return "SCE_RC_GRN_NONBOND [Id=" + Id + ", MESSAGE_ID=" + MESSAGE_ID + ", WHSEID=" + WHSEID + ", DocumentNo="
				+ DocumentNo + ", Description=" + Description + ", TransferfromCode=" + TransferfromCode
				+ ", TransfertoCode=" + TransfertoCode + ", ReceiptDate=" + ReceiptDate + ", Line_No=" + Line_No
				+ ", ItemNo=" + ItemNo + ", ManufacturingLotNo=" + ManufacturingLotNo + ", UnitofMeasureCode="
				+ UnitofMeasureCode + ", QtytoReceive=" + QtytoReceive + ", QtytoReceiveBase=" + QtytoReceiveBase
				+ ", EANCode=" + EANCode + ", QtyperUnitofMeasure=" + QtyperUnitofMeasure + ", Quantity=" + Quantity
				+ ", QuantityBase=" + QuantityBase + ", ExpirationDate=" + ExpirationDate + ", LotNo=" + LotNo
				+ ", ManufacturingDate=" + ManufacturingDate + ", RDD=" + RDD + ", QualityStatus=" + QualityStatus
				+ ", TNOPAL=" + TNOPAL + ", SourceSubType=" + SourceSubType + "]";
	}	
}