...
public class SCE_RC_STOCK_ADJ {
	...
	public SCE_RC_STOCK_ADJ(Long id, String mESSAGE_ID, String wHSEID, Double line_No, String itemNo,
			LocalDateTime postingDate, LocalTime postingTime, Double entryType, Double documentNo, String description,
			Double eDILocationCode, String locationCode, String unitofMeasureCode, Double quantity, Double quantityBase,
			String reasonCode, Double eANCode, String vLCode, Double entryNo, String qtyperUnitofMeasure,
